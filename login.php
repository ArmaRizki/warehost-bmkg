...
<body>
    ...
    <div id="padding" style="border-radius: 20px;">
<script>
    function togglePadding() {
        ...
        if (screenWidth <= 768) {
            paddingElement.style.boxShadow = '0px 0px 0px rgba(67, 94, 190, 0.255)';
        } else {
            paddingElement.style.boxShadow = '10px 2px 540px rgba(67, 94, 190, 0.255)';
        }
    }
    ...
    window.addEventListener('resize', togglePadding);
        ...
        <div class="auth-box" style="display: flex; width: 100%; max-width: 1100px; margin: 0 auto;">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class=""></div>
                    <h1 class="auth-title mb-3" style="font-size: 3.2em; text-align: center;">Login</h1>
                    <p class="auth-subtitle mb-1" style="font-size: 1.2em; text-align: center;">Warehouse Management </p>
                    <p class="auth-subtitle mb-3" style="font-size: 1.2em; text-align: center;">BMKG Stageof Sleman</p>
                    <?php if($err){ ?>
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="form-check form-check-lg d-flex align-items-center">
                                    <input id="flexCheckDefault" class="form-check-input me-2" type="checkbox" name="ingataku" value="1" <?php if($ingataku == '1') echo "checked"?>>
